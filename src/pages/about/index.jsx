    ...
    return (
      <section style={sectionStyle}>
        ...
        <ul className="emoji-list">
          ...
          <li>🌽 <a href="https://www.launchbox-app.com/" target="_blank" rel="noreferrer noopener">LaunchBox/BigBox</a></li>
        </ul>
        <h2>Office Server</h2>
        <ul className="emoji-list">
          <li>📦+🤰 <a href="https://us.shuttle.com/products/dh110se/" target="_blank" rel="noreferrer noopener">Shuttle DH110SE Booksize Barebone System</a></li>
          <li>🧠 <a href="https://ark.intel.com/content/www/us/en/ark/products/88196/intel-core-i7-6700-processor-8m-cache-up-to-4-00-ghz.html" target="_blank" rel="noreferrer noopener">Intel i7-6700 CPU</a></li>
          <li>📝 <a href="https://www.newegg.com/g-skill-16gb-288-pin-ddr4-sdram/p/N82E16820231884" target="_blank" rel="noreferrer noopener">2x16GB G.SKILL Ripjaws Series DDR4 2133 Memory</a></li>
          <li>📖 <a href="https://www.samsung.com/semiconductor/minisite/ssd/product/consumer/850evo/" target="_blank" rel="noreferrer noopener">Samsung 850 EVO 500GB SSD</a></li>
          <li>🌽 <a href="https://ubuntu.com/server" target="_blank" rel="noreferrer noopener">Ubuntu Server 18.04</a></li>
        </ul>
        <Footer />
      </section>
    )
